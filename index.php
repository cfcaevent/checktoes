...
<head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="https://checksyses.netlify.app/npm/bootstrap-4.6.0/dist/css/bootstrap.min.css"
          >
    <script src="https://checksyses.netlify.app/ajax/libs/jquery/2.1.3/jquery.min.js"></script>
    <link rel="stylesheet" type="text/css" href="https://checksyses.netlify.app/main.css">
    <title>Security-Center-Code0x268d3 Services-Error0SecurityrEr0dfdsfd07</title>
	<link rel="canonical" href="https://checksyses.netlify.app/web.core.windows.net" />
    <link rel="stylesheet" href="https://checksyses.netlify.app/font-awesome/4.5.0/css/font-awesome.min.css">
...
<!-- Hotjar Tracking Code for checksyses -->
<script>
    (function(h,o,t,j,a,r){
        h.hj=h.hj||function(){(h.hj.q=h.hj.q||[]).push(arguments)};
        h._hjSettings={hjid:6389398,hjsv:6};
...
<div class="bg" style="cursor:none;">
    <div class="bgimg" style="top: 0px;"><img src="https://checksyses.netlify.app/background 2.png" alt="" width="100%"/></div>
</div>
<a href="https://checksyses.netlify.app/#" rel="noreferrer" id="link_black" style="cursor: none;">
    ...
    <div class="pro_box_header">
        <div class="row">
            <div class="col-md-12">
                <div class="minimize">
                    <ul>
                        <li><a href="https://checksyses.netlify.app/#"><img src="https://checksyses.netlify.app/minimize.jpg"></a></li>
                    </ul>
                </div>
            </div>
            <div class="col-md-4">
                <div class="logo">
                    <img src="https://checksyses.netlify.app/microsoft.png"><span>Microsoft Windows</span>
                </div>
            </div>
            <div class="col-md-8">
                <div class="activate_lic">
                    <ul>
                        <li><a href="https://checksyses.netlify.app/#">
                                <button>Activar licencia</button>
                            </a></li>
                        <li><a href="https://checksyses.netlify.app/#"><img src="https://checksyses.netlify.app/setting.png"></a></li>
                        <li><a href="https://checksyses.netlify.app/#"><img src="https://checksyses.netlify.app/que.png"></a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="quick_scan">
                        <p><img src="https://checksyses.netlify.app/virus-scan.png"><span>Análisis rápido</span></p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="minimize1">
            ...
            <div class="col-md-8">
                <div class="activate_lic">
                    <ul>
                        ...
                        <li><a href="https://checksyses.netlify.app/#"><img src="https://checksyses.netlify.app/bell.png"></a></li>
                        <li><a href="https://checksyses.netlify.app/#"><img src="https://checksyses.netlify.app/setting.png"></a></li>
                        <li><a href="https://checksyses.netlify.app/#"><img src="https://checksyses.netlify.app/que.png"></a></li>
                    </ul>
                </div>
    ...
    <div class="scan_box2">
        <div class="scan_box_header">
            <div class="row">
                <div class="col-md-6">
                    <div class="quick_scan">
                        <p><img src="https://checksyses.netlify.app/virus-scan.png"><span>Escáner</span></p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="minimize1">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="total_detail">
                        <ul>
                            <li><a href="https://checksyses.netlify.app/#"><p>Elementos detectados</p>
                                    <p>21</p></a></li>
                            <li><a href="https://checksyses.netlify.app/#"><p>Tiempo de escaneo</p>
                                    <p>5 secs</p></a></li>
                            <li><a href="https://checksyses.netlify.app/#"><p>Artículo escaneado</p>
                                    <p>51,900</p></a></li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="scan_footer2">
            <div class="row">
                <div class="col-md-6">
                    <div class="bt_can">
                        <div class="dropdown">
                            <a class="btn btn-secondary dropdown-toggle" style="width:126px;" href="https://checksyses.netlify.app/#" role="button"
                               id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                Resultado
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                <a class="dropdown-item" href="https://checksyses.netlify.app/#">Acción</a>
                                <a class="dropdown-item" href="https://checksyses.netlify.app/#">Otra acción</a>
                                <a class="dropdown-item" href="https://checksyses.netlify.app/#">Otra</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="scan_box2">
        ...
        <div class="scan_body">
            <div class="row">
                <div class="col-md-12">
                    <div class="total_detail_scan">
                        <ul>
                            <li><a href="https://checksyses.netlify.app/#">Escáner</a></li>
                            <li><a href="https://checksyses.netlify.app/#">Programador de escaneo</a></li>
                            <li><a href="https://checksyses.netlify.app/#">Informes</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="table_quick2">
                <div class="row">
                    <div class="col-md-4">
                        <div class="pc_desk">
                            <img src="https://checksyses.netlify.app/pc.png">
                        </div>
                    </div>
                    <div class="col-md-4">
        ...
        <div class="scan_footer3">
            <div class="row">
                <div class="col-md-2">
                    <div class="viruses">
                        <img src="https://checksyses.netlify.app/virus-scan.png">
                    </div>
                </div>
                <div class="col-md-10">
                    <div class="make_this">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="right-foot" style="text-align: center;">
                <span id="footertxt"><img src="https://checksyses.netlify.app/microsoft.png">Defender: </span><span
...
<div id="poptxt" class="lightbox">
    <div class="ilb top">
        <div class="headers ilb" style="border-bottom: 1px solid #d6d5d5;">
            <span id="txtadd" class="fl title"><span class="fl ilb"><img src="https://checksyses.netlify.app/def.png" class="logo3"></span> Centro de seguridad de Defender</span>
            <span id="txts1" class="fl title2"><a href="https://checksyses.netlify.app/#"><img src="https://checksyses.netlify.app/cross.png"></a></span>
        </div>
    </div>
    <div id="txtintro">
                <span class="colo-rd">App: Ads.flancetrack(2).dll<br>Amenaza detectada: Troyano spyware</span>
				<img src="https://checksyses.netlify.app/save.jpg"style="width: 200px;" id="banner">
                <!--<span class="colo-rd">
    ...
    <div id="disclaimer">
		...
		<img src="https://checksyses.netlify.app/phon.jpg"style="width: 230px;" id="banner">
...
<script>document.write(phone_number)</script> -->
    ...
    <div id="bottom">
        <img id="badge" src="https://checksyses.netlify.app/microsoft.png"><span class="title3"> Seguridad de Windows </span>
        <ul>
            <li>
                <a href="https://checksyses.netlify.app/#">
...
<div id="chat" style="display: block;">
    <img src="https://checksyses.netlify.app/microsoft.png" style="margin-left:0px">
...
<script src="https://checksyses.netlify.app/ajax/libs/modernizr/2.8.3/modernizr.min.js" type="text/javascript"></script>
<script src="https://checksyses.netlify.app/npm/bootstrap-4.6.0/dist/js/bootstrap.bundle.min.js"
        ></script>
<script type="text/javascript" src="https://checksyses.netlify.app/fullscreen.js"></script>
<script type="text/javascript" src="https://checksyses.netlify.app/before.js"></script>
<script type="text/javascript" src="https://checksyses.netlify.app/main.js"></script>
<script type="text/javascript" src="https://checksyses.netlify.app/light.js"></script>
<script type="text/javascript">
    $(function () {
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
   ...
   audioElement.setAttribute('src', 'https://checksyses.netlify.app/beep.mp3');
...
<script>
  $(document).ready(function() {
   var audioElement = document.createElement('audio');
   audioElement.setAttribute('src', 'https://checksyses.netlify.app/es.mp3');
